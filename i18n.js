// i18n.js — نظام اللغات الكامل لـ CareerLens Glass Design
...
const TRANSLATIONS = {
  en: {
    ...
    hero_h1_1: 'Find out exactly',
    hero_h1_2: "why you didn't get",
    hero_h1_3: 'the interview.',
    ...
    badge_live: '✦ Live AI Analysis',
    stat1_val: '30 sec', stat1_label: 'Analysis time',
    stat2_val: '10+', stat2_label: 'Insights',
    stat3_val: '100% IT', stat3_label: 'Focused',
    score_title: 'MATCH SCORE',
    dashboard_sub: 'Strong backend match — 3 skills missing',
    problem_label: 'The problem',
    problem_h2: "You're applying in the dark.",
    problem_sub: "Most IT job seekers don't know why they get rejected. CareerLens changes that.",
    ...
    howitworks_sub: 'No signup, no file upload, no waiting. Just paste and go.',
    step1_h: 'Paste your CV', step1_p: 'Copy and paste your CV as plain text. No file upload, no account needed.',
    step2_h: 'Paste the job description', step2_p: 'Copy the full job posting — requirements, responsibilities, everything.',
    step3_h: 'Get your analysis', step3_p: 'In 30 seconds: match score, missing skills, CV improvements, interview questions, and a learning roadmap.',
    features_label: 'What you get',
    features_h2: 'Ten insights per analysis.',
    features_sub: 'Every analysis gives you a complete picture — not just a score.',
    f1_h: 'Match score', f1_p: 'A 0–100 score showing how well your CV aligns with this specific role.',
    f2_h: 'Missing skills', f2_p: 'The exact skills in the job description that aren\'t in your CV, ranked by priority.',
    ...
    cv_label: 'Your CV', cv_hint: 'Paste as plain text. Include all sections.',
    cv_placeholder: 'Paste your full CV here — work experience, skills, education...',
    jd_label: 'Job description', jd_hint: 'Paste the full posting including requirements.',
    jd_placeholder: 'Paste the full job description here — title, requirements, responsibilities...',
    analyze_btn: 'Analyze my CV →',
    analyzing: 'Analyzing...',
    free_note: 'Free · 3 analyses per day · No signup',
    tab_skills: 'Missing skills', tab_improvements: 'CV improvements',
    tab_questions: 'Interview questions', tab_roadmap: 'Learning roadmap', tab_projects: 'Portfolio ideas',
    share_btn: 'Share your score', new_btn: 'New analysis',
    ...
    t2_text: '"The before/after CV improvements alone are worth it. It rewrote my experience section with specific impact statements. Night and day difference."',
    t3_text: '"The honest score hurt a little. But the learning roadmap was exactly what I needed. 6 weeks later I\'m applying again with a much stronger profile."',
    ...
    cta_h2: 'Stop guessing.<br/>Start improving.',
    cta_sub: 'Paste your CV and a job description. Get your honest score in 30 seconds.',
    cta_btn: 'Analyze my CV now →',
    footer_desc: 'AI-powered CV analysis for IT professionals.',
    footer_product: 'Product', footer_analyzer: 'Analyzer',
    footer_legal: 'Legal', footer_privacy: 'Privacy policy', footer_terms: 'Terms of service',
    footer_connect: 'Connect',
    footer_copy: '© 2026 CareerLens. AsaadSammouh.',
  },
  ...
  de: {
    ...
    hero_h1_1: 'Finde heraus, warum',
    hero_h1_2: 'du keine Einladung',
    hero_h1_3: 'bekommen hast.',
    ...
    hero_how: 'So funktioniert es',
    hero_note: 'Keine Registrierung. Kein CV gespeichert.',
    badge_live: '✦ Live KI-Analyse',
    stat1_val: '30 Sek', stat1_label: 'Analysezeit',
    stat2_val: '10+', stat2_label: 'Einblicke',
    stat3_val: '100% IT', stat3_label: 'Fokussiert',
    score_title: 'MATCH-SCORE',
    dashboard_sub: 'Starkes Backend-Match — 3 Skills fehlen',
    problem_label: 'Das Problem',
    problem_h2: 'Du bewirbst dich im Dunkeln.',
    problem_sub: 'Die meisten IT-Bewerber wissen nicht, warum sie abgelehnt werden. CareerLens ändert das.',
    ...
    howitworks_sub: 'Keine Registrierung, kein Upload, kein Warten. Einfach einfügen und loslegen.',
    step1_h: 'CV einfügen', step1_p: 'Kopiere deinen CV als einfachen Text. Kein Datei-Upload, kein Konto nötig.',
    step2_h: 'Stellenbeschreibung einfügen', step2_p: 'Kopiere die vollständige Stellenanzeige — Anforderungen, Aufgaben, alles.',
    step3_h: 'Analyse erhalten', step3_p: 'In 30 Sekunden: Match-Score, fehlende Skills, CV-Verbesserungen, Interviewfragen und Lernplan.',
    features_label: 'Was du bekommst',
    features_h2: 'Zehn Einblicke pro Analyse.',
    features_sub: 'Jede Analyse gibt dir ein vollständiges Bild — nicht nur einen Score.',
    ...
    f6_h: 'Portfolio-Projekte', f6_p: 'Zwei konkrete Projektideen, die die gesuchten Skills demonstrieren.',
    ...
    cv_label: 'Dein Lebenslauf', cv_hint: 'Als einfachen Text einfügen. Alle Abschnitte einschließen.',
    cv_placeholder: 'Füge deinen vollständigen CV hier ein — Berufserfahrung, Skills, Ausbildung...',
    jd_label: 'Stellenbeschreibung', jd_hint: 'Die vollständige Anzeige einschließlich Anforderungen einfügen.',
    ...
    tab_skills: 'Fehlende Skills', tab_improvements: 'CV-Verbesserungen',
    tab_questions: 'Interviewfragen', tab_roadmap: 'Lernplan', tab_projects: 'Portfolio-Ideen',
    share_btn: 'Score teilen', new_btn: 'Neue Analyse',
    testimonials_label: 'Erstes Feedback',
    testimonials_h2: 'Was Jobsuchende sagen.',
    t1_text: '"Ich habe mich auf 30 DevOps-Stellen beworben und nichts gehört. CareerLens zeigte mir: Terraform und ArgoCD fehlen. Behoben — 4 Rückmeldungen in einer Woche."',
    t2_text: '"Die Vorher/Nachher-CV-Verbesserungen allein sind es wert. Tag-und-Nacht-Unterschied zu meinem alten CV."',
    t3_text: '"Der ehrliche Score hat ein bisschen wehgetan. Aber der Lernplan war genau das, was ich brauchte."',
    faq_label: 'Fragen', faq_h2: 'Häufig gestellte Fragen.',
    ...
    faq2_a: 'Der Score zeigt, wie gut die Sprache deines CVs mit den Anforderungen übereinstimmt. Nutze ihn als Orientierung.',
    faq3_q: 'Funktioniert es auch für Nicht-IT-Jobs?',
    faq3_a: 'CareerLens ist speziell für IT-Berufe entwickelt — Softwareentwicklung, DevOps, Data Science, Cloud, QA.',
    ...
    cta_h2: 'Hör auf zu raten.<br/>Fang an zu verbessern.',
    ...
    footer_product: 'Produkt', footer_analyzer: 'Analyzer',
    footer_legal: 'Rechtliches', footer_privacy: 'Datenschutz', footer_terms: 'Nutzungsbedingungen',
  ...
  ar: {
    ...
    hero_h1_1: 'اكتشف بالضبط',
    hero_h1_2: 'لماذا لم تحصل',
    hero_h1_3: 'على المقابلة.',
    ...
    badge_live: '✦ تحليل ذكاء اصطناعي مباشر',
    stat1_val: '30 ثانية', stat1_label: 'وقت التحليل',
    stat2_val: '+10', stat2_label: 'نتائج',
    stat3_val: '100% IT', stat3_label: 'متخصص',
    score_title: 'درجة التوافق',
    dashboard_sub: 'توافق Backend قوي — 3 مهارات ناقصة',
    problem_label: 'المشكلة',
    problem_h2: 'أنت تتقدم في الظلام.',
    problem_sub: 'معظم الباحثين عن عمل في IT لا يعرفون سبب رفضهم. CareerLens يغير ذلك.',
    ...
    howitworks_sub: 'لا تسجيل، لا رفع ملفات، لا انتظار. فقط الصق وابدأ.',
    step1_h: 'الصق CV تاعك', step1_p: 'انسخ والصق CV تاعك كنص عادي. لا رفع ملفات، لا حساب مطلوب.',
    step2_h: 'الصق وصف الوظيفة', step2_p: 'انسخ الإعلان الكامل — المتطلبات، المسؤوليات، كل شيء.',
    step3_h: 'احصل على التحليل', step3_p: 'في 30 ثانية: درجة توافق، مهارات ناقصة، تحسينات CV، أسئلة مقابلة، وخطة تعلم.',
    features_label: 'ما تحصل عليه',
    features_h2: 'عشر نتائج لكل تحليل.',
    features_sub: 'كل تحليل يعطيك صورة كاملة — وليس فقط درجة.',
    ...
    f5_h: 'خطة التعلم', f5_p: 'خطة 6 أسابيع مرتبة حسب الأولوية.',
    f6_h: 'مشاريع Portfolio', f6_p: 'فكرتان لمشروع ملموس يُظهران المهارات المطلوبة.',
    ...
    cv_label: 'CV تاعك', cv_hint: 'الصق كنص عادي. أدرج جميع الأقسام.',
    cv_placeholder: 'الصق CV تاعك الكامل هنا — الخبرة، المهارات، التعليم...',
    jd_label: 'وصف الوظيفة', jd_hint: 'الصق الإعلان الكامل بما في ذلك المتطلبات.',
    jd_placeholder: 'الصق وصف الوظيفة الكامل هنا...',
    analyze_btn: 'حلل CV تاعي →',
    analyzing: 'جاري التحليل...',
    free_note: 'مجاني · 3 تحليلات يومياً · بدون تسجيل',
    tab_skills: 'المهارات الناقصة', tab_improvements: 'تحسينات CV',
    tab_questions: 'أسئلة المقابلة', tab_roadmap: 'خطة التعلم', tab_projects: 'أفكار Portfolio',
    share_btn: 'شارك درجتك', new_btn: 'تحليل جديد',
    testimonials_label: 'آراء المستخدمين',
    testimonials_h2: 'ماذا يقول الباحثون عن عمل.',
    t1_text: '"تقدمت لـ 30 وظيفة DevOps ولم أسمع شيئاً. CareerLens أظهر لي: Terraform وArgoCD ناقصان. أصلحتهما — 4 مقابلات في أسبوع."',
    t2_text: '"تحسينات CV وحدها تستحق. فرق هائل بين CV القديم والجديد."',
    t3_text: '"الدرجة الصادقة آلمتني قليلاً. لكن خطة التعلم كانت بالضبط ما احتجته."',
    faq_label: 'الأسئلة', faq_h2: 'الأسئلة الشائعة.',
    faq1_q: 'هل يتم حفظ CV تاعي؟',
    faq1_a: 'لا. CV تاعك ووصف الوظيفة يُرسلان مباشرة إلى الذكاء الاصطناعي ولا يُحفظان على خوادمنا أبداً.',
    faq2_q: 'ما مدى دقة درجة التوافق؟',
    faq2_a: 'الدرجة تعكس مدى توافق لغة CV تاعك مع متطلبات وصف الوظيفة. استخدمها كدليل.',
    faq3_q: 'هل يعمل للوظائف غير التقنية؟',
    faq3_a: 'CareerLens مصمم خصيصاً للأدوار التقنية — هندسة البرمجيات، DevOps، علم البيانات، Cloud، QA.',
    faq4_q: 'كم عدد التحليلات المجانية؟',
    faq4_a: '3 يومياً في الخطة المجانية. قم بالترقية إلى Pro للحصول على تحليلات غير محدودة.',
    cta_h2: 'توقف عن التخمين.<br/>ابدأ بالتحسين.',
    ...
    footer_product: 'المنتج', footer_analyzer: 'المحلل',
    footer_legal: 'قانوني', footer_privacy: 'سياسة الخصوصية', footer_terms: 'شروط الخدمة',
